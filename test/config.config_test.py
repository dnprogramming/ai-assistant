...
class TestConfig(unittest.TestCase):
    ...
    @patch.dict(os.environ, {"CREDENTIALS": "test_credentials", "ASSISTANT_SCOPES": "test_scopes", "GEMINI_API_KEY": "test_key", "EMAIL_TO_LISTEN_FOR": "test_email", "MAIN_SCOPES": "test_main_scopes"})
